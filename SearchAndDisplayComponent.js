...
class SearchBar extends React.Component {
  constructor(props){
    ...
    this.handlerCheckChanged = this.handlerCheckChanged.bind(this);
  }
      ...
      <form>
        ...
        <p>
          <input
            type="checkbox"
            checked={inStockOnly}
            onChange={this.handlerCheckChanged}
            />
          {' '}
...
class FilterableProductTable extends React.Component {
  ...
  handleInputChanged(filter){
    this.setState( {filterText: filter} );
  }
  handleCheckChanged(inStock){
    ...
    return (
      <div>
        <SearchBar
          ...
          onTextChange={this.handleInputChanged}
          onStockChange={this.handleCheckChanged}
        />
        <ProductTable
